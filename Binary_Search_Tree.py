...
class Binary_Search_Tree:
  ...
  # discussed in class
   ...
   def __balance(self, t):
      ...
      if (balance == 2):
         if (self._get_balance(t.right) == 1):
            t.height -= 2
            t = self._rotate_left(t)
         elif (self._get_balance(t.right) == 0):
            t.height -= 1
            t.right.height += 1
            t = self._rotate_left(t)
         else:
         ...
         if (self._get_balance(t.left) == -1):
            t.height -= 2
            t = self._rotate_right(t)
         elif (self._get_balance(t.left) == 0):
            t.height -= 1
            t.left.height += 1
            t = self._rotate_right(t)
         else:
   ...
   def to_list(self):
      return self.rec_to_list(self.__root)
      
   def rec_to_list(self, t):
      if (t is None):
         return []
      elif (t.left is None and t.right is None):
         return [t.value]
      elif (t.left is not None and t.right is not None):
         rlist = self.rec_to_list(t.left)
         rlist.append(t.value)
         for i in self.rec_to_list(t.right):
            rlist.append(i)
         return rlist
      elif (t.left is None and t.right is not None):
         rlist = [t.value]
   ...
   def jim(self):
      ...
      print(self.__root.left.value)
      print(self.__root.right.value)
